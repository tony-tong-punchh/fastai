...
class FirstCell(nn.Module):
    def __init__(self, in_channels_left, out_channels_left, in_channels_right, out_channels_right):
        ...
        self.conv_1x1.add_module(
            "conv", nn.Conv2d(in_channels_right, out_channels_right, 1, stride=1, bias=False)
        )
        self.conv_1x1.add_module(
            "bn", nn.BatchNorm2d(out_channels_right, eps=0.001, momentum=0.1, affine=True)
        )
        ...
        self.path_1.add_module(
            "conv", nn.Conv2d(in_channels_left, out_channels_left, 1, stride=1, bias=False)
        )
        self.path_2 = nn.ModuleList()
        self.path_2.add_module("pad", nn.ZeroPad2d((0, 1, 0, 1)))
        self.path_2.add_module("avgpool", nn.AvgPool2d(1, stride=2, count_include_pad=False))
    ...
    def forward(self, x, x_prev):
        ...
        x_out = torch.cat(
            [x_left, x_comb_iter_0, x_comb_iter_1, x_comb_iter_2, x_comb_iter_3, x_comb_iter_4], 1
        )
        return x_out
...
class NormalCell(nn.Module):
    def __init__(self, in_channels_left, out_channels_left, in_channels_right, out_channels_right):
        ...
        self.conv_prev_1x1.add_module(
            "bn", nn.BatchNorm2d(out_channels_left, eps=0.001, momentum=0.1, affine=True)
        )
...
class NASNetALarge(nn.Module):
    def __init__(self, use_classifier=False, num_classes=1001):
        ...
        self.conv0.add_module(
            "conv",
            nn.Conv2d(
                in_channels=3, out_channels=96, kernel_size=3, padding=0, stride=2, bias=False
            ),
        )
