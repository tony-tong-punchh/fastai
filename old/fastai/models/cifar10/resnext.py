  ...
  """
    ...
    def __init__(self, inplanes, planes, cardinality, base_width, stride=1, downsample=None):
        ...
        self.conv_conv = nn.Conv2d(
            D * C, D * C, kernel_size=3, stride=stride, padding=1, groups=cardinality, bias=False
        )
...
class CifarResNeXt(nn.Module):
  ...
  """
    ...
    def __init__(self, block, depth, cardinality, base_width, num_classes):
        ...
        self.cardinality, self.base_width, self.num_classes, self.block = (
            cardinality,
            base_width,
            num_classes,
            block,
    ...
    def _make_layer(self, planes, stride=1):
        ...
        layers = []
        layers.append(
            self.block(self.inplanes, planes, self.cardinality, self.base_width, stride, downsample)
        )
