...
def plot_confusion_matrix(
    cm, classes, normalize=False, title="Confusion matrix", cmap=plt.cm.Blues, figsize=None
):
    """
...
class ImageModelResults:
    ...
    def most_by_correct(self, y, is_correct):
        ...
        return self.most_by_mask(
            ((self.preds == self.ds.y) == is_correct) & (self.ds.y == y), y, mult
        )
