...
def inception_4(pre):
    return children(inceptionv4(pretrained=pre))[0]
...
def inceptionresnet_2(pre):
    return load_pre(pre, InceptionResnetV2, "inceptionresnetv2-520b38e4")
...
def resnext101(pre):
    return load_pre(pre, resnext_101_32x4d, "resnext_101_32x4d")
...
def resnext101_64(pre):
    return load_pre(pre, resnext_101_64x4d, "resnext_101_64x4d")


@_fastai_model(
    "Wide Residual Networks", "Wide Residual Networks", "https://arxiv.org/pdf/1605.07146.pdf"
)
def wrn(pre):
    return load_pre(pre, wrn_50_2f, "wrn_50_2f")
...
def dn121(pre):
    return children(densenet121(pre))[0]
...
def dn169(pre):
    return children(densenet169(pre))[0]
...
def dn201(pre):
    return children(densenet201(pre))[0]


@_fastai_model(
    "Vgg-16 with batch norm added",
