...
def test_wrapped_functions():
    ...
    try:
        nbtest.get_file(loss_func)
    except:
        raise AssertionError("show_test should handle __wrapped__ loss functions")
...
def test_fuzzy_test_match():
    ...
    lines = [
        ...
        "def test_related():",
        "    return related().mock_function()" "def test_substring():",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            {  # old
                "a": [{"file": "mod1", "line": 19, "test": "test1"},],
                "b": [
        ...
        (
            ...
            {  # new
                "a": [{"file": "mod1", "line": 35, "test": "test1"},],
                "b": [{"file": "mod3", "line": 26, "test": "test3"},],
            },
            {  # expected
                "a": [{"file": "mod1", "line": 35, "test": "test1"},],
                "b": [
        ...
        (
            ...
            {  # new
                "a": [{"file": "mod1", "line": 35, "test": "test2"},],
                "c": [{"file": "mod3", "line": 16, "test": "test3"},],
            },
            {  # expected
                "a": [
