...
def create_metrics_dataframe(learn):
    ...
    records = [
        ...
        for i, (loss, val_loss, epoch_metrics) in enumerate(
            zip(get_train_losses(learn), learn.recorder.val_losses, learn.recorder.metrics)
        )
    ]
...
def test_logger():
    ...
    pd.testing.assert_frame_equal(
        csv_df_notime, recorder_df, check_exact=False, check_less_precise=2
    )
