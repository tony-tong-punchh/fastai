...
def model_g2master_g(
    model_params: Sequence[Tensor], master_params: Sequence[Tensor], flat_master: bool = False
) -> None:
...
class MixedPrecision(LearnerCallback):
    ...
    def __init__(
        ...
        self.flat_master, self.dynamic, self.max_noskip, self.clip, self.max_scale = (
            flat_master,
            dynamic,
            max_noskip,
            clip,
