...
try:
    ...
    print("To use this tracker, please run 'pip install mlflow'")
...
class MLFlowTracker(LearnerCallback):
    ...
    def __init__(
        ...
        self.learn, self.exp_name, self.params, self.nb_path, self.uri = (
            learn,
            exp_name,
            params,
            nb_path,
    ...
    def on_train_begin(self, **kwargs: Any) -> None:
        ...
        self.exp_id = (
            self.client.create_experiment(self.exp_name) if exp is None else exp.experiment_id
        )
