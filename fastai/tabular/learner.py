...
def _cl_int_plot_tab_top_losses(
    self, k, largest: bool = True, return_table: bool = False
) -> Optional[plt.Figure]:
    ...
    df = pd.DataFrame(
        columns=[["Prediction", "Actual", "Loss", "Probability"] + cat_names + cont_names]
    )
